...
class Full_Address(models.Model):
    City = models.CharField("City Name",unique=False,max_length = 20)
    Area = models.CharField("Area",unique=False,max_length=20)
    Street = models.CharField("Street",unique=False,max_length=20)
    House_Num = models.CharField("House Number",unique=False,max_length=20)
...
class Album(models.Model):
    ...
    Producer = models.ForeignKey(Musician, on_delete=models.CASCADE)
    class Meta:
        db_table = "album"
    def __str__(self):
